...
class EvalT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--source_motion', default='doublefinalmotionref263.npy', type=str, help="Source motion path for editing. (new_joint_vecs format .npy file)")
